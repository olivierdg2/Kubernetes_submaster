...
//+kubebuilder:rbac:groups=branch.example.com,resources=submasters,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=branch.example.com,resources=submasters/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=branch.example.com,resources=submasters/finalizers,verbs=update
